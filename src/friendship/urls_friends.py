...
from .views import send_friendship_request, accept_friendship_request, reject_friendship_request, remove_friend,  show_friendship_requests, entry_list
...
urlpatterns = [
    ...
    path('all_users_list', entry_list, name='all_users'),
