...
def send_notification_to_message_receiver(sender, instance: Friendship, created, *args, **kwargs):
...
def send_notification_to_page_owner_where_post_has_been_published(sender, instance: Post, created, *args, **kwargs):
...
def send_notification_to_chat_members_about_new_message(sender, instance: Message, created, *args, **kwargs):
    author = instance.author
    chat = instance.chat
