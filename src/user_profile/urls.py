...
from .views import UserProfile, user_profile_part_where_we_show_friends, post_like_button, user_profile_information_edit, remove_post
...
urlpatterns = [
    ...
    path('profile/delete_post/<int:post_id>', remove_post, name='remove_post')
